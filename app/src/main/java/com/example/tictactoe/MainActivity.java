...
public class MainActivity extends AppCompatActivity {
    ...
    private boolean checkPlayerWin()
    {
        ...
        for(int i = 0; i <combinationList.size();i++)
        {
            ...
            if(boxPositions[combination[0]] == playerTurn && boxPositions[combination[i]] == playerTurn && boxPositions[combination[2]] == playerTurn)
            {
                reponse = true;
            }
        }
    ...
    void restartMatch()
    {
        ...
        image1.setImageResource(R.drawable.textback);
        image2.setImageResource(R.drawable.textback);
        image3.setImageResource(R.drawable.textback);
        image4.setImageResource(R.drawable.textback);
        image5.setImageResource(R.drawable.textback);
        image6.setImageResource(R.drawable.textback);
        image7.setImageResource(R.drawable.textback);
        image8.setImageResource(R.drawable.textback);
        image9.setImageResource(R.drawable.textback);
